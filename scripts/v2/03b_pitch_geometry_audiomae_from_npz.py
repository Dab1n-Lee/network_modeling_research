...
def main():
    ...
    out_csv = out_dir / "audiomae_layerwise_geometry_split.csv"
    ...
    plot_lines(["slope_pure","slope_harm","slope_cross"], "AudioMAE: slope by pair type", "slope (dist ~ Δcents)", "layerwise_slope_split.png")
    plot_lines(["pearson_r_pure","pearson_r_harm","pearson_r_cross"], "AudioMAE: Pearson r by pair type", "Pearson r", "layerwise_r_split.png")
    plot_lines(["curv_p_mean_deg","curv_h_mean_deg"], "AudioMAE: curvature proxy (within-condition)", "mean angle (deg)", "layerwise_curv_split.png")
