...
def main() -> None:
    meta_path = PROJECT_ROOT / "data" / "stimuli_v2" / "stimuli_meta_v2.csv"
    ...
    for r in tqdm(rows):
        ...
        cond = r["condition"]
        wav_path = PROJECT_ROOT / "data" / "stimuli_v2" / cond / f"{stim_id}.wav"
    ...
    out_path = OUT_DIR / "audiomae_layerwise_embeddings_v2.npz"
    np.savez_compressed(
        out_path,
        embeddings=E,
